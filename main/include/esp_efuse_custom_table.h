...
extern const esp_efuse_desc_t* ESP_EFUSE_EP_DATA[];
extern const esp_efuse_desc_t* ESP_EFUSE_EP_DATA_SERIAL_NO[];
extern const esp_efuse_desc_t* ESP_EFUSE_EP_DATA_RESERVED[];
